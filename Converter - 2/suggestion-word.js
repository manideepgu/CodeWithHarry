...
function getSuggestions(combinations){
    console.log("INSIDE GET SUGGESTIONS");
    let suggestions=[];
    console.log(combinations);   
    combinations.forEach(eachCombination => { 
        let finalSuggestion=[];
        for(let i=0;i<eachCombination.length;i++){
            ...
            let item=[];
            let suggestionsForElement=searchAllBengWords(eachCombinationElement)
...
function getSuggestionWithoutBlanksAndDuplicates(combinations){
    console.log("INSIDE getSuggestionWithoutBlankAndDuplicates....")
    let suggestions=getSuggestions(combinations)

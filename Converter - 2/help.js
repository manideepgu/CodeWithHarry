...
function findBengMatch(text){
    ...
    while(currentWord!=""){
        ...
        let bengWord = searchBengWordWithMostUse(searchAllBengWords(currentWord));
        if(bengWord==false){
...
function searchAllBengWords(subWord){
    console.log(dictionary);
...
export {findCurrentWord, findBengMatch, createFullDictionary, searchAllBengWords};